import { AssignmetExpr, BinaryExpr, Identifier, ObjectLiteral } from "../../frontend/ast.ts";
...
export function eval_assignment (node: AssignmetExpr, env: Environment): RuntimeVal {
